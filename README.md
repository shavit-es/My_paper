...
**Comparison of Steel Surface Defects Classification Model based on
...
**이 논문을 김은서, 심이지, 이현희, 오승주의**

**학사학위 졸업논문으로 인준함.**

**[지도교수 이 동 호 ㊞]{.underline}**
...
[1.1. 연구 배경 [- 8 -](#연구-배경)](#연구-배경)

[1.2. 연구목적 및 연구범위 [- 9
-](#연구목적-및-연구범위)](#연구목적-및-연구범위)

[2. 기존연구 [- 10 -](#기존연구)](#기존연구)

[2.1. 문헌조사 요약 [- 10 -](#문헌조사-요약)](#문헌조사-요약)

[2.2. 문헌조사 [- 10 -](#문헌조사)](#문헌조사)

[2.2.1. EfficientNet [- 10 -](#efficientnet)](#efficientnet)

[2.2.2. Vision Transformer [- 12
-](#vision-transformer)](#vision-transformer)

[2.2.3. Support Vector Machine [- 15
-](#support-vector-machine)](#support-vector-machine)

[2.2.4. 랜덤 포레스트(Random Forest) [- 17
-](#랜덤-포레스트random-forest)](#랜덤-포레스트random-forest)

[2.2.5. 철강 표면 검사 [- 17 -](#철강-표면-검사)](#철강-표면-검사)

[2.3. 차별성 및 우수성 [- 18 -](#차별성-및-우수성)](#차별성-및-우수성)

[3. 문제정의 [- 18 -](#문제정의)](#문제정의)

[3.1. 머신러닝을 활용한 이미지 분류 [- 18
-](#머신러닝을-활용한-이미지-분류)](#머신러닝을-활용한-이미지-분류)

[3.2. 열간압연(열연) 공정 [- 19
-](#열간압연열연-공정)](#열간압연열연-공정)

[3.3 표면 결함 검출 시스템 [- 23
-](#표면-결함-검출-시스템)](#표면-결함-검출-시스템)

[4. 접근방법 [- 23 -](#접근방법)](#접근방법)

[4.1. 서버 환경 [- 23 -](#서버-환경)](#서버-환경)

[4.2. 성능 평가 지표 [- 24 -](#성능-평가-지표)](#성능-평가-지표)

[4.3. 하이퍼파라미터 [- 24 -](#하이퍼파라미터)](#하이퍼파라미터)

[4.3.1. Efficient Net [- 25 -](#efficient-net)](#efficient-net)

[4.3.2. Vision Transformer [- 26
-](#vision-transformer-1)](#vision-transformer-1)

[4.3.3. SVM [- 28 -](#svm)](#svm)

[4.3.4. Random Forest [- 28 -](#random-forest)](#random-forest)

[5. 연구결과 [- 30 -](#연구결과)](#연구결과)

[5.1. EfficientNet [- 30 -](#efficientnet-1)](#efficientnet-1)

[5.2. Vision Transformer [- 34
-](#vision-transformer-2)](#vision-transformer-2)

[5.3. SVM [- 37 -](#svm-1)](#svm-1)

[5.4. Random Forest [- 39 -](#random-forest-1)](#random-forest-1)

[5.5. 모델 비교 [- 42 -](#모델-비교)](#모델-비교)

[6. 논의 및 결론 [- 43 -](#논의-및-결론)](#논의-및-결론)

[참고 문헌 [- 45 -](#_Toc106329824)](#_Toc106329824)
...
![](./images/media/image1.png){width="5.930734908136483in"
height="2.3542902449693788in"}
...
![](./images/media/image2.png){width="2.9596423884514436in"
height="2.119229002624672in"}![테이블이(가) 표시된 사진 자동 생성된
설명](./images/media/image3.png){width="3.443007436570429in"
height="1.1256714785651794in"}
...
![](./images/media/image4.png){width="5.228791557305337in"
height="2.7962970253718287in"}

기본적으로 Transformer 구조에서는 다음과 같이 각 단어가 벡터로 표현되어
입력된다.

![](./images/media/image5.png){width="2.2008048993875766in"
...
설명](./images/media/image6.png){width="4.556619641294838in"
height="1.8860553368328958in"}
...
![](./images/media/image7.png){width="2.7878488626421696in"
height="2.158333333333333in"}![](./images/media/image8.png){width="2.2398512685914262in"
...
> ![](./images/media/image9.png){width="1.225in"
> height="0.5626454505686789in"}\*w는 가중치를 의미
...
![](./images/media/image10.png){width="3.775259186351706in"
height="2.533429571303587in"}
...
![](./images/media/image11.png){width="4.751943350831146in"
height="1.9826957567804024in"}
...
![](./images/media/image12.png){width="3.9587937445319334in"
height="2.6877351268591427in"}
...
![](./images/media/image13.png){width="3.317349081364829in"
height="3.2313462379702536in"}
...
설명](./images/media/image14.png){width="3.4246259842519686in"
height="2.517057086614173in"}
...
설명](./images/media/image15.png){width="4.472163167104112in"
height="1.6836734470691164in"}
...
![](./images/media/image16.png){width="3.2592596237970253in"
height="2.3473425196850393in"}

\<그래프\> 초기 학습의 epoch-accuracy 그래프

![텍스트이(가) 표시된 사진 자동 생성된
설명](./images/media/image17.png){width="3.2777777777777777in"
height="2.32454615048119in"}
...
하이퍼파라미터별 결과값은 다음과 같다.
  ...
  ----------------------------------------------------------------------------------------
           **Resolution     **Batch   **Shuffle   **Epoch**   **Optimizer**   **learning
           (Input size)**   size**    buffer                                  rate**
                                      size**                                  
  -------- ---------------- --------- ----------- ----------- --------------- ------------
  **1**    **EfficientNET   **8**     **128**     **100**     **Adam**        **1e-2**
           B0(224×224)**                                                      
...
+---+----------+-----+---------+---------+-----------+------+--------+
|   | **Reso   | **  | *       | **Batch | **PAT     | *    | **Lear |
|   | lution** | See | *Buffer | size**  | CH_SIZE** | *Epo | ning** |
|   |          | d** | size**  |         |           | ch** |        |
|   | **(Input |     |         |         |           |      | **     |
|   | size)**  |     |         |         |           |      | Rate** |
+===+==========+=====+=========+=========+===========+======+========+
